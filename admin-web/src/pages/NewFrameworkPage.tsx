...
export default function NewFrameworkPage() {
  ...
  const createMutation = useMutation({
    mutationFn: () => apiFetch('/api/v1/frameworks', { method: 'POST', body: JSON.stringify({ templateId: selected!.id, name }) }),
  ...
  return (
    <div>
      ...
      <p className="text-sm text-slate-500 mb-6">Choose a template matching your course category — you can customise it afterward.</p>
